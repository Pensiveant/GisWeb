...
const LayerList: React.FC<LayerListProps> = () => {
  /**
   * reference:https://echarts.apache.org/examples/zh/editor.html?c=geo-lines
   */
  function loadMap() {
    var geoCoordMap: any = {
      海门: [121.15, 31.89],
    ...
    var chart = new EchartsLayer(window.view, null);
  ...
  function onCheck(checkedKeys: any, info: any) {
    ...
    if (checkedKeys.includes('MigrationMap')) {
      loadMap();
    }

    if (checkedKeys.includes('ScatterDiagram')) {
      loadScatterDiagram();
    }
  }
