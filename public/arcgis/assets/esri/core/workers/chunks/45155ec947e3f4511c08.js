  ...
  [3127],
  {
    33127: (e, t, i) => {
      ...
      var s = i(66643),
        ...
        h = i(44547),
        p = i(24470),
        m = (i(66577), i(80442), i(92604)),
        f = i(54102),
        d = i(40488);
      const y = m.Z.getLogger('esri.layers.support.ElevationSampler');
      class x {
        queryElevation(e) {
          return (function (e, t) {
            const i = g(e, t.spatialReference);
            if (!i) return null;
            switch (e.type) {
              case 'point':
                !(function (e, t, i) {
                  e.z = (0, o.Pt)(i.elevationAt(t), 0);
                })(e, i, t);
                break;
              case 'polyline':
                !(function (e, t, i) {
                  w.spatialReference = t.spatialReference;
      ...
      class v extends x {
        constructor(e, t, i) {
          super(),
            (this.tile = e),
            (this.noDataValue = i),
            (this.extent = (0, p.HH)(e.tile.extent, t.spatialReference));
          const s = (0, a.c9)(t.spatialReference),
            n = t.lodAt(e.tile.level).resolution * s;
          this.demResolution = { min: n, max: n };
        }
        ...
        contains(e) {
          ...
          return (0, f.aV)(this.extent, t);
        }
        elevationAt(e) {
          const t = this.projectIfRequired(e, this.spatialReference);
          if ((0, o.Wi)(t)) return null;
          if (!this.contains(e)) {
            const t = this.extent,
              i = `${t.xmin}, ${t.ymin}, ${t.xmax}, ${t.ymax}`;
            return (
              y.warn(
                '#elevationAt()',
                `Point used to sample elevation (${e.x}, ${e.y}) is outside of the sampler extent (${i})`,
              ),
              this.noDataValue
            );
          }
      ...
      class T extends x {
        constructor(e, t, i) {
          ...
          super(),
            'number' == typeof t
              ? ((this.noDataValue = t), (s = null))
              : ((s = t), (this.noDataValue = i)),
            (this.samplers = s
              ? e.map((e) => new v(e, s, this.noDataValue))
              : e);
          const n = this.samplers[0];
          if (n) {
            this.extent = n.extent.clone();
            const { min: e, max: t } = n.demResolution;
            this.demResolution = { min: e, max: t };
            for (let e = 1; e < this.samplers.length; e++) {
              const t = this.samplers[e];
              this.extent.union(t.extent),
            ...
            (this.extent = (0, p.HH)((0, p.Ue)(), s.spatialReference)),
        ...
        elevationAt(e) {
          const t = this.projectIfRequired(e, this.spatialReference);
          if (!t) return null;
          for (const e of this.samplers)
            if (e.contains(t)) return e.elevationAt(t);
          return (
            y.warn(
              '#elevationAt()',
              `Point used to sample elevation (${e.x}, ${e.y}) is outside of the sampler`,
            ),
            this.noDataValue
          );
        }
      ...
      function g(e, t) {
        ...
        return (
          s ||
            y.error(
              `Cannot project geometry spatial reference (wkid:${i.wkid}) to elevation sampler spatial reference (wkid:${t.wkid})`,
            ),
          s
        );
      }
      ...
      class _ {
        constructor(e, t = null) {
          if (((this.tile = e), (0, o.pC)(t))) {
            const i = e.extent;
            this.samplerData = {
              pixelData: t.values,
              width: t.width,
              height: t.height,
              safeWidth: 0.99999999 * (t.width - 1),
              noDataValue: t.noDataValue,
              dx: (t.width - 1) / (i[2] - i[0]),
              dy: (t.width - 1) / (i[3] - i[1]),
              x0: i[0],
              y1: i[3],
            };
          }
        ...
        sample(e, t) {
          if ((0, o.Wi)(this.samplerData)) return;
          const {
              safeWidth: i,
              width: s,
              pixelData: n,
      ...
      class q {
        async queryAll(e, t, i) {
          if (
            !(e =
              i && i.ignoreInvisibleLayers
                ? e.filter((e) => e.visible)
                : e.slice()).length
          )
            throw new n.Z(
          ...
          const s = A.fromGeometry(t);
          let o = !1;
          (i && i.returnSampleInfo) || (o = !0);
          const l = { ...M, ...i, returnSampleInfo: !0 },
            a = await this.query(e[e.length - 1], s, l),
            r = await this._queryAllContinue(e, a, l);
          return (
            (r.geometry = r.geometry.export()), o && delete r.sampleInfo, r
          );
        }
        async query(e, t, i) {
          if (!e)
          ...
          const s = { ...M, ...i },
            o = new C(e, t.spatialReference, s),
            l = s.signal;
          return (
            await e.load({ signal: l }),
            await this._createGeometryDescriptor(o, t, l),
            await this._selectTiles(o, l),
            await this._populateElevationTiles(o, l),
            this._sampleGeometryWithElevation(o),
            this._createQueryResult(o, l)
          );
        }
        async createSampler(e, t, i) {
          ...
          const s = { ...M, ...i };
          return this._createSampler(e, t, s);
        }
        async createSamplerAll(e, t, i) {
          ...
          const s = { ...M, ...i, returnSampleInfo: !0 },
            o = await this._createSampler(e[e.length - 1], t, s);
          return this._createSamplerAllContinue(e, t, o, s);
        }
        async _createSampler(e, t, i, s) {
          ...
          o.equals(l) ||
            (await (0, h.iQ)([{ source: o, dest: l }], { signal: n }),
            (t = (0, h.iV)(t, l)));
          const a = new D(e, t, i, s);
          return (
            await this._selectTiles(a, n),
            await this._populateElevationTiles(a, n),
            new T(a.elevationTiles, a.layer.tileInfo, a.options.noDataValue)
          );
        }
        async _createSamplerAllContinue(e, t, i, s) {
          if ((e.pop(), !e.length)) return i;
          const n = i.samplers.map((e) => (0, p.oJ)(e.extent)),
        ...
        async _queryAllContinue(e, t, i) {
          ...
          for (let i = 0; i < n.length; i++) {
            const a = t.sampleInfo[i];
            a.demResolution >= 0
              ? a.source || (a.source = s)
              : e.length && (o.push(n[i]), l.push(i));
          }
          if (!e.length || 0 === o.length) return t;
          const a = t.geometry.clone(o),
            r = await this.query(e[e.length - 1], a, i);
          return (
            l.forEach((e, i) => {
              (n[e].z = r.geometry.coordinates[i].z),
                (t.sampleInfo[e].demResolution = r.sampleInfo[i].demResolution);
            }),
        ...
        async _createQueryResult(e, t) {
          const i = {
            geometry: (
              await e.geometry.project(e.outSpatialReference, t)
            ).export(),
            noDataValue: e.options.noDataValue,
          };
          return (
            e.options.returnSampleInfo &&
              (i.sampleInfo = this._extractSampleInfo(e)),
        ...
        async _createGeometryDescriptor(e, t, i) {
          ...
          if (
            (t instanceof A
              ? (s = await t.project(o, i))
              : (await (0, h.iQ)([{ source: t.spatialReference, dest: o }], {
                  signal: i,
                }),
                (s = (0, h.iV)(t, o))),
            !s)
            ...
            throw new n.Z(
              ...
              `Cannot query elevation in '${t.spatialReference.wkid}' on an elevation service in '${o.wkid}'`,
            );
          e.geometry = A.fromGeometry(s);
        }
        ...
        _preselectOutsideLayerExtent(e) {
          ...
          e.geometry.coordinates.forEach((e) => {
            const s = e.x,
              n = e.y;
            (s < i.xmin || s > i.xmax || n < i.ymin || n > i.ymax) &&
              (e.elevationTile = t);
          });
        }
        _selectTilesClosestResolution(e) {
          const t = e.layer.tileInfo,
            i = this._findNearestDemResolutionLODIndex(
              t,
        ...
        _findNearestDemResolutionLODIndex(e, t) {
          const i = t / (0, a.c9)(e.spatialReference);
          let s = e.lods[0],
            n = 0;
          for (let t = 1; t < e.lods.length; t++) {
            const o = e.lods[t];
            Math.abs(o.resolution - i) < Math.abs(s.resolution - i) &&
              ((s = o), (n = t));
          }
          return n;
        }
        async _selectTilesFinestContiguous(e, t) {
          const i = Z(e.layer.tileInfo, e.options.minDemResolution);
          ...
          try {
            if (o)
              await (0, l.Hl)(
                Promise.all(
                  a.map((e) =>
                    o.fetchAvailability(e.level, e.row, e.col, { signal: i }),
                  ),
                ),
                i,
              );
            else if (
              (await this._populateElevationTiles(e, i),
              !e.allElevationTilesFetched())
            )
              throw (
                (e.clearElevationTiles(),
                new n.Z('elevation-query:has-unavailable-tiles'))
              );
          } catch (s) {
            (0, l.r9)(s),
              await this._selectTilesFinestContiguousAt(e, t - 1, i);
          }
        }
        async _populateElevationTiles(e, t) {
          const i = e.getTilesToFetch(),
            ...
            r = i.map(async (i) => {
              const l = `${e.layer.uid}:${i.id}:${a}`,
                r = (0, o.pC)(n) ? n.get(l) : null,
                c = (0, o.pC)(r)
                  ? r
                  : await e.layer.fetchTile(i.level, i.row, i.col, {
                      noDataValue: a,
                      signal: t,
                    });
              (0, o.pC)(n) && n.put(l, c), (s[i.id] = new _(i, c));
            });
          await (0, l.Hl)((0, l.as)(r), t), e.populateElevationTiles(s);
        }
        async _selectTilesAuto(e, t) {
          this._selectTilesAutoFinest(e),
            this._reduceTilesForMaximumRequests(e);
          const i = e.layer.tilemapCache;
          if (!i) return this._selectTilesAutoPrefetchUpsample(e, t);
          const n = e.getTilesToFetch(),
            o = {},
            a = n.map(async (e) => {
              const n = {
                  id: null,
                ...
                a = await (0, s.q6)(
                  i.fetchAvailabilityUpsample(e.level, e.row, e.col, n, {
                    signal: t,
                  }),
                );
              !1 === a.ok ? (0, l.r9)(a.error) : (o[e.id] = n);
            });
          await (0, l.Hl)(Promise.all(a), t), e.remapTiles(o);
        }
        _reduceTilesForMaximumRequests(e) {
          ...
          for (
            ...
            l &&
            ((l = !1),
            e.forEachTileToFetch((s) => {
              i <= e.options.maximumAutoTileRequests ||
                (o(s), t.upsampleTile(s) && (l = !0), n(s));
            }, o),
            l);
        ...
        _sampleGeometryWithElevation(e) {
          e.geometry.coordinates.forEach((t) => {
            ...
            if (i) {
              ...
              (0, o.pC)(e) ? (s = e) : (t.elevationTile = null);
            }
            t.z = s;
          });
        }
        _extractSampleInfo(e) {
          const t = e.layer.tileInfo,
            i = (0, a.c9)(t.spatialReference);
          return e.geometry.coordinates.map((s) => {
            let n = -1;
            return (
              s.elevationTile &&
                s.elevationTile !== e.outsideExtentTile &&
      ...
      class A {
        ...
        clone(e) {
          ...
          return (
            ...
            (t.coordinates =
              e || this.coordinates.map((e) => this._cloneCoordinate(e))),
        ...
        async project(e, t) {
          ...
          await (0, h.iQ)([{ source: this.spatialReference, dest: e }], {
            signal: t,
          });
          const i = new r.Z({
        ...
        static fromGeometry(e) {
          ...
          if (
            ...
            (t.coordinates = e.coordinates.map((e) => t._cloneCoordinate(e))),
              (t._exporter = (t, i) => {
                const s = e.clone(t);
            ...
            switch (e.type) {
              case 'point': {
                ...
                (t.coordinates =
                  ...
                  (t._exporter = (t, i) =>
                    e.hasM
                      ? new c.Z(t[0].x, t[0].y, t[0].z, t[0].m, i)
                      : new c.Z(t[0].x, t[0].y, t[0].z, i));
                break;
              }
              case 'multipoint': {
                const i = e,
                ...
                (t.coordinates =
                  s && n
                    ...
                    : s
                    ? i.points.map((e) => ({ x: e[0], y: e[1], z: e[2] }))
                    : n
                    ? i.points.map((e) => ({ x: e[0], y: e[1], m: e[2] }))
                    : i.points.map((e) => ({ x: e[0], y: e[1] }))),
                  (t._exporter = (t, i) =>
                    e.hasM
                      ? new r.Z({
              ...
              case 'polyline': {
                ...
                for (const e of i.paths)
                  if ((n.push([a, a + e.length]), (a += e.length), o && l))
                    for (const t of e)
                      s.push({ x: t[0], y: t[1], z: t[2], m: t[3] });
                  else if (o)
                    for (const t of e) s.push({ x: t[0], y: t[1], z: t[2] });
                  else if (l)
                    for (const t of e) s.push({ x: t[0], y: t[1], m: t[2] });
                  else for (const t of e) s.push({ x: t[0], y: t[1] });
                (t.coordinates = s),
                  (t._exporter = (t, i) => {
                    const s = e.hasM
                        ? t.map((e) => [e.x, e.y, e.z, e.m])
                        : t.map((e) => [e.x, e.y, e.z]),
      ...
      class C extends I {
        ...
        clearElevationTiles() {
          for (const e of this.geometry.coordinates)
            e.elevationTile !== this.outsideExtentTile &&
              (e.elevationTile = null);
        }
        ...
        getTilesToFetch() {
          ...
          for (const i of this.geometry.coordinates) {
            const s = i.tile;
            i.elevationTile || !i.tile || e[s.id] || ((e[s.id] = s), t.push(s));
          }
          return t;
        }
      ...
      class D extends I {
        constructor(e, t, i, s) {
          super(e, i),
            ...
            (this.elevationTiles = []),
            (this.candidateTiles = []),
            (this.fetchedCandidates = new Set()),
        ...
        selectTilesAtLOD(e, t) {
          ...
          s < 0
            ...
            : this._selectCandidateTilesCoveringExtentAt(s);
        }
        _maximumLodForRequests(e) {
          const t = this.layer.tileInfo;
          if (!e) return t.lods.length - 1;
          const i = this.extent;
          if ((0, o.Wi)(i)) return -1;
        ...
        remapTiles(e) {
          this.candidateTiles = this._uniqueNonOverlappingTiles(
            this.candidateTiles.map((t) => e[t.id]),
          );
        }
        getTilesToFetch() {
        ...
        forEachTileToFetch(e, t) {
          ...
          (this.candidateTiles = []),
            i.forEach((i) => {
              ...
              let s = !1;
              e(i, () => (s = !0)), s ? t && t(i) : this.candidateTiles.push(i);
            }),
            (this.candidateTiles = this._uniqueNonOverlappingTiles(
              this.candidateTiles,
              t,
        ...
        _uniqueNonOverlappingTiles(e, t) {
          const i = {},
            s = [];
          for (const n of e) i[n.id] ? t && t(n) : ((i[n.id] = n), s.push(n));
          const n = s.sort((e, t) => e.level - t.level);
          return n.filter((e, i) => {
            for (let s = 0; s < i; s++)
              if ((0, p.r3)(n[s].extent, e.extent)) return t && t(e), !1;
            return !0;
          });
        }
        _selectCandidateTilesCoveringExtentAt(e) {
          ...
          const i = this.layer.tileInfo,
            s = i.lods[e],
            n = i.tileAt(s.level, t.xmin, t.ymin),
            l = s.resolution * i.size[0],
            a = s.resolution * i.size[1],
            r = Math.ceil((t.xmax - n.extent[0]) / l),
            c = Math.ceil((t.ymax - n.extent[1]) / a);
          for (let e = 0; e < c; e++)
            for (let t = 0; t < r; t++) {
              const s = {
                id: null,
              ...
              i.updateTileInfo(s),
                this._tileIsMasked(s) || this.candidateTiles.push(s);
            }
        }
        _tileIsMasked(e) {
          return (
            !!this.maskExtents &&
            this.maskExtents.some((t) => (0, p.r3)(t, e.extent))
          );
        }
      }
      function Z(e, t) {
        ...
        if (t > 0) {
          const s = e.lods.findIndex((e) => e.resolution < t);
          0 === s ? (i = 0) : s > 0 && (i = s - 1);
        }
        return i;
      }
