  ...
  [4695],
  {
    90344: (e, t, n) => {
      ...
      const a = { year: 'numeric', month: 'numeric', day: 'numeric' },
        ...
        s = { year: 'numeric', month: 'long', weekday: 'long', day: 'numeric' },
        u = { hour: 'numeric', minute: 'numeric' },
        h = { ...u, second: 'numeric' },
        m = {
          'short-date': a,
          'short-date-short-time': { ...a, ...u },
          'short-date-short-time-24': { ...a, ...u, hour12: !1 },
          'short-date-long-time': { ...a, ...h },
          'short-date-long-time-24': { ...a, ...h, hour12: !1 },
          'short-date-le': a,
          'short-date-le-short-time': { ...a, ...u },
          'short-date-le-short-time-24': { ...a, ...u, hour12: !1 },
          'short-date-le-long-time': { ...a, ...h },
          'short-date-le-long-time-24': { ...a, ...h, hour12: !1 },
          'long-month-day-year': l,
          'long-month-day-year-short-time': { ...l, ...u },
          'long-month-day-year-short-time-24': { ...l, ...u, hour12: !1 },
          'long-month-day-year-long-time': { ...l, ...h },
          'long-month-day-year-long-time-24': { ...l, ...h, hour12: !1 },
          'day-short-month-year': i,
          'day-short-month-year-short-time': { ...i, ...u },
          'day-short-month-year-short-time-24': { ...i, ...u, hour12: !1 },
          'day-short-month-year-long-time': { ...i, ...h },
          'day-short-month-year-long-time-24': { ...i, ...h, hour12: !1 },
          'long-date': s,
          'long-date-short-time': { ...s, ...u },
          'long-date-short-time-24': { ...s, ...u, hour12: !1 },
          'long-date-long-time': { ...s, ...h },
          'long-date-long-time-24': { ...s, ...h, hour12: !1 },
      ...
      function f(e, t) {
        return (function (e) {
          ...
          if (!g.has(t)) {
            const e = (0, o.Kd)(),
              n = d[(0, o.Kd)()] || e;
            g.set(t, new Intl.DateTimeFormat(n, t));
          }
          return g.get(t);
        })(t).format(e);
      }
      (0, o.Ze)(() => {
        (g = new WeakMap()), (y = m['short-date-short-time']);
      });
    },
    70171: (e, t, n) => {
      var r, o, a;
      let l;
      n.d(t, { Ze: () => d, Kd: () => u, qe: () => m });
      const i =
        null != (r = null == (o = globalThis.esriConfig) ? void 0 : o.locale)
          ? r
          : null == (a = globalThis.dojoConfig)
          ? void 0
          : a.locale;
      function s() {
        var e, t;
      ...
      null == globalThis.addEventListener ||
        globalThis.addEventListener('languagechange', function () {
          const e = null != undefined ? undefined : s();
          l !== e &&
            ((l = e),
            [...c].forEach((t) => {
              t.call(null, e);
      ...
      function u(e, t) {
        return (function (e) {
          ...
          if (!l.has(t)) {
            const n = (0, o.Kd)(),
              r = a[(0, o.Kd)()] || n;
            l.set(t, new Intl.NumberFormat(r, e));
          }
          return (0, r.j0)(l.get(t));
        })(t).format(e);
      }
      (0, o.Ze)(() => {
        (l = new WeakMap()), (i = {});
    ...
    14695: (e, t, n) => {
      n.r(t), n.d(t, { createLabelFunction: () => d, formatField: () => g });
      var r = n(20102),
        o = n(92604),
        a = n(90344),
        l = n(18848),
        ...
        s = n(8813),
        u = n(59266);
      const h = o.Z.getLogger('esri.layers.support.labelFormatUtils'),
        m = { type: 'simple', evaluate: () => null },
        c = { getAttribute: (e, t) => e.field(t) };
      async function d(e, t, o) {
        if (!e || !e.symbol) return m;
        const a = e.where,
          l = (0, s.hV)(e),
          i = a ? await Promise.resolve().then(n.bind(n, 41534)) : null;
        let d;
        if ('arcade' === l.type) {
          const e = await (0, u.WW)(l.expression, o, t);
          d = {
            type: 'arcade',
            evaluate(t) {
              try {
                const n = e.evaluate({
                  $feature: 'attributes' in t ? e.repurposeFeature(t) : t,
                });
                ...
                h.error(
                  new r.Z(
                    ...
                    { feature: t, expression: l },
                  ),
                );
              }
              return null;
            },
            needsHydrationToEvaluate: () => null == (0, s.el)(l.expression),
          };
        } else
          d = {
            type: 'simple',
            evaluate: (e) =>
              l.expression.replace(/{[^}]*}/g, (n) => {
                const r = n.slice(1, -1),
                  o = t.get(r);
                if (!o) return n;
                let a = null;
        ...
        if (a) {
          let e;
          try {
            e = i.WhereClause.create(a, t);
          } catch (e) {
            return m;
          }
          const n = d.evaluate;
          d.evaluate = (t) => {
            const r = 'attributes' in t ? void 0 : c;
            return e.testFeature(t, r) ? n(t) : null;
          };
        }
        return d;
      }
      function g(e, t) {
        ...
        const n = t.domain;
        if (n)
          if ('codedValue' === n.type || 'coded-value' === n.type) {
            const t = e;
            for (const e of n.codedValues) if (e.code === t) return e.name;
          } else if ('range' === n.type) {
            const t = +e,
              r = 'range' in n ? n.range[0] : n.minValue,
              o = 'range' in n ? n.range[1] : n.maxValue;
            if (r <= t && t <= o) return n.name;
          }
        let r = e;
        return (
          'date' === t.type || 'esriFieldTypeDate' === t.type
            ? (r = (0, a.p6)(r, (0, a.Ze)('short-date')))
            : (0, i.H7)(t) && (r = (0, l.uf)(+r)),
          r || ''
        );
      }
    ...
    8813: (e, t, n) => {
      ...
      function g(e) {
        ...
        return (
          e
            ? ((t = (0, r.gx)(e, (e) => o + '$feature["' + e + '"]' + a)),
              (t = s.test(t) ? t.replace(s, '') : '"' + t),
              (t = u.test(t) ? t.replace(u, '') : t + '"'),
              (t = t.replace(l, '" + ').replace(i, ' + "')))
            : (t = '""'),
          t
        );
      }
      ...
      function v(e) {
        if (!e) return null;
        let t = p.exec(e) || f.exec(e);
        return t ? t[1] || t[3] : ((t = x.exec(e)), t ? t[2] : null);
      }
    },
  },
]);
