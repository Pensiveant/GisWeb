...
(self.webpackChunkRemoteClient = self.webpackChunkRemoteClient || []).push([
  [6481],
  {
    4307: (e, t, r) => {
      ...
      Object.freeze({
        ...
        normalize: function (e, t) {
          ...
          return (
            f > 0 &&
              ((f = 1 / Math.sqrt(f)), (e[0] = t[0] * f), (e[1] = t[1] * f)),
            e
          );
        },
        dot: function (e, t) {
        ...
        cross: function (e, t, r) {
          const s = t[0] * r[1] - t[1] * r[0];
          return (e[0] = e[1] = 0), (e[2] = s), e;
        },
        lerp: function (e, t, r, s) {
          const f = t[0],
            n = t[1];
          return (e[0] = f + s * (r[0] - f)), (e[1] = n + s * (r[1] - n)), e;
        },
        random: function (e, t) {
          t = t || 1;
        ...
        transformMat2: function (e, t, r) {
          const s = t[0],
            f = t[1];
          return (e[0] = r[0] * s + r[2] * f), (e[1] = r[1] * s + r[3] * f), e;
        },
        transformMat2d: o,
        ...
        transformMat4: function (e, t, r) {
          const s = t[0],
            f = t[1];
          return (
            (e[0] = r[0] * s + r[4] * f + r[12]),
            (e[1] = r[1] * s + r[5] * f + r[13]),
            e
          );
        },
        rotate: function (e, t, r, s) {
          const f = t[0] - r[0],
            n = t[1] - r[1],
            u = Math.sin(s),
            i = Math.cos(s);
          return (
            (e[0] = f * i - n * u + r[0]), (e[1] = f * u + n * i + r[1]), e
          );
        },
        angle: function (e, t) {
          const r = e[0],
          ...
          i > 0 && (i = 1 / Math.sqrt(i));
          const y = (r * f + s * n) * u * i;
          return y > 1 ? 0 : y < -1 ? Math.PI : Math.acos(y);
        },
        str: function (e) {
          return 'vec2(' + e[0] + ', ' + e[1] + ')';
        },
        ...
        equals: function (e, t) {
          const r = e[0],
            ...
            u = t[1];
          return (
            Math.abs(r - n) <= s.E * Math.max(1, Math.abs(r), Math.abs(n)) &&
            Math.abs(f - u) <= s.E * Math.max(1, Math.abs(f), Math.abs(u))
          );
        },
        projectAndScale: function (e, t, r, s, f) {
          let n = t[0] - r[0],
            u = t[1] - r[1];
          const i = (s[0] * n + s[1] * u) * (f - 1);
          return (
            (n = s[0] * i),
            (u = s[1] * i),
            (e[0] = t[0] + n),
    ...
    56481: (e, t, r) => {
      ...
      class s {
        constructor(e, t, r = 0, s, f) {
          (this.TypedArrayConstructor = e), (this.elementCount = 9);
          const n = this.TypedArrayConstructor;
          void 0 === s && (s = 9 * n.BYTES_PER_ELEMENT);
          const u = 0 === t.byteLength ? 0 : r;
          (this.typedBuffer =
            null == f
              ? new n(t, u)
              : new n(t, u, (f - r) / n.BYTES_PER_ELEMENT)),
            (this.typedBufferStride = s / n.BYTES_PER_ELEMENT),
        ...
        getMat(e, t) {
          let r = e * this.typedBufferStride;
          for (let e = 0; e < 9; e++) t[e] = this.typedBuffer[r++];
          return t;
        }
        setMat(e, t) {
          let r = e * this.typedBufferStride;
          for (let e = 0; e < 9; e++) this.typedBuffer[r++] = t[e];
        }
        get(e, t) {
        ...
        copyFrom(e, t, r) {
          const s = this.typedBuffer,
            f = t.typedBuffer;
          let n = e * this.typedBufferStride,
            u = r * t.typedBufferStride;
          for (let e = 0; e < 9; ++e) s[n++] = f[u++];
        }
        get buffer() {
      ...
      class f {
        constructor(e, t, r = 0, s, f) {
          ...
          const n = this.TypedArrayConstructor;
          void 0 === s && (s = 16 * n.BYTES_PER_ELEMENT);
          const u = 0 === t.byteLength ? 0 : r;
          (this.typedBuffer =
            null == f
              ? new n(t, u)
        ...
        getMat(e, t) {
          let r = e * this.typedBufferStride;
          for (let e = 0; e < 16; e++) t[e] = this.typedBuffer[r++];
          return t;
        }
        setMat(e, t) {
          let r = e * this.typedBufferStride;
          for (let e = 0; e < 16; e++) this.typedBuffer[r++] = t[e];
        }
        get(e, t) {
          return this.typedBuffer[e * this.typedBufferStride + t];
        }
      ...
      class n {
        constructor(e, t, r = 0, s, f) {
          ...
          const n = this.TypedArrayConstructor;
          void 0 === s && (s = n.BYTES_PER_ELEMENT);
          const u = 0 === t.byteLength ? 0 : r;
          (this.typedBuffer =
            null == f
              ? new n(t, u)
      ...
      class i {
        constructor(e, t, r = 0, s, f) {
          ...
          const n = this.TypedArrayConstructor;
          void 0 === s && (s = 2 * n.BYTES_PER_ELEMENT);
          const u = 0 === t.byteLength ? 0 : r;
          (this.typedBuffer =
            null == f
              ? new n(t, u)
        ...
        getVec(e, t) {
          return (
            ...
            (0, u.s)(t, this.typedBuffer[e], this.typedBuffer[e + 1])
          );
        }
        setVec(e, t) {
          (e *= this.typedBufferStride),
      ...
      class c {
        constructor(e, t, r = 0, s, f) {
          ...
          const n = this.TypedArrayConstructor;
          void 0 === s && (s = 3 * n.BYTES_PER_ELEMENT);
          const u = 0 === t.byteLength ? 0 : r;
          (this.typedBuffer =
            null == f
              ? new n(t, u)
        ...
        getVec(e, t) {
          return (
            ...
            (0, y.s)(
              t,
              this.typedBuffer[e],
              this.typedBuffer[e + 1],
              this.typedBuffer[e + 2],
            )
          );
        }
        setVec(e, t) {
      ...
      class d {
        constructor(e, t, r = 0, s, f) {
          ...
          const n = this.TypedArrayConstructor;
          void 0 === s && (s = 4 * n.BYTES_PER_ELEMENT);
          const u = 0 === t.byteLength ? 0 : r;
          (this.typedBuffer =
            null == f
              ? new n(t, u)
      ...
      class _ extends n {
        ...
        static fromTypedArray(e, t) {
          return new _(e.buffer, e.byteOffset, t, e.byteOffset + e.byteLength);
        }
      }
      _.ElementType = 'u16';
      class x extends i {
