...
(self.webpackChunkRemoteClient = self.webpackChunkRemoteClient || []).push([
  [8326, 4889],
  {
    78346: (e, t, r) => {
      ...
      class w {
        ...
        async _workerMessageHandler(e) {
          ...
          if (t && t.type === u.Cs.OPEN) {
            ...
            o || (o = await import(e));
            const s = a.default.connect(o);
            this._workerPostMessage({ type: u.Cs.OPENED, jobId: r, data: s });
          }
        }
      }
      var b = r(70171),
        v = r(17202);
      const _ = d.Z.getLogger('esri.core.workers'),
        { HANDSHAKE: C } = u.Cs;
      let k, S;
      const j =
      ...
      let E = 0;
      const M = d.Z.getLogger('esri.core.workers'),
        { ABORT: P, INVOKE: N, OPEN: Z, OPENED: x, RESPONSE: O } = u.Cs;
      class I {
        constructor(e, t) {
        ...
        static async create(e) {
          const t = await (async function () {
                ...
                const e =
                  'let globalId=0;const outgoing=new Map,configuration=JSON.parse("{CONFIGURATION}");self.esriConfig=configuration.esriConfig;const workerPath=self.esriConfig.workers.workerPath,HANDSHAKE=0,OPEN=1,OPENED=2,RESPONSE=3,INVOKE=4,ABORT=5;function createAbortError(){const e=new Error("Aborted");return e.name="AbortError",e}function receiveMessage(e){return e&&e.data?"string"==typeof e.data?JSON.parse(e.data):e.data:null}function invokeStaticMessage(e,o,r){const t=r&&r.signal,n=globalId++;return new Promise(((r,i)=>{if(t){if(t.aborted)return i(createAbortError());t.addEventListener("abort",(()=>{outgoing.get(n)&&(outgoing.delete(n),self.postMessage({type:5,jobId:n}),i(createAbortError()))}))}outgoing.set(n,{resolve:r,reject:i}),self.postMessage({type:4,jobId:n,methodName:e,abortable:null!=t,data:o})}))}let workerRevisionChecked=!1;function checkWorkerRevision(e){if(!workerRevisionChecked&&e.kernelInfo){workerRevisionChecked=!0;const{revision:o,buildDate:r,version:t}=configuration.kernelInfo,{revision:n,buildDate:i,version:s}=e.kernelInfo;o!==n&&console.warn(`[esri.core.workers] Version mismatch detected between ArcGIS API for JavaScript and assets:\\nAPI version: ${t} [Date: ${r}, Revision: ${o.slice(0,8)}]\nAssets version: ${s} [Date: ${i}, Revision: ${n.slice(0,8)}]`)}}function messageHandler(e){const o=receiveMessage(e);if(!o)return;const r=o.jobId;switch(o.type){case 1:let e;function t(o){const t=e.connect(o);self.postMessage({type:2,jobId:r,data:t},[t])}"function"==typeof define&&define.amd?require([workerPath],(r=>{e=r.default||r,checkWorkerRevision(e),e.loadWorker(o.modulePath).then((e=>e||new Promise((e=>{require([o.modulePath],e)})))).then(t)})):"System"in self&&"function"==typeof System.import?System.import(workerPath).then((r=>(e=r.default,checkWorkerRevision(e),e.loadWorker(o.modulePath)))).then((e=>e||System.import(o.modulePath))).then(t):esriConfig.workers.useDynamicImport?import(workerPath).then((r=>{e=r.default||r,checkWorkerRevision(e),e.loadWorker(o.modulePath).then((e=>e||import(o.modulePath))).then(t)})):(self.RemoteClient||importScripts(workerPath),e=self.RemoteClient.default||self.RemoteClient,checkWorkerRevision(e),e.loadWorker(o.modulePath).then(t));break;case 3:if(outgoing.has(r)){const e=outgoing.get(r);outgoing.delete(r),o.error?e.reject(JSON.parse(o.error)):e.resolve(o.data)}}}self.dojoConfig=configuration.loaderConfig,esriConfig.workers.loaderUrl&&(self.importScripts(esriConfig.workers.loaderUrl),"function"==typeof require&&"function"==typeof require.config&&require.config(configuration.loaderConfig)),self.addEventListener("message",messageHandler),self.postMessage({type:0});'.replace(
                    ...
                    `'${(function () {
                      ...
                      } else e = JSON.parse(JSON.stringify(p.Z));
                      (e.assetsPath = (0, h.hF)(e.assetsPath)),
                        ...
                        e.workers.workerPath
                          ...
                          : (e.workers.workerPath = (0, h.hF)(
                              (0, c.V)('esri/core/workers/RemoteClient.js'),
                            )),
                        (e.workers.useDynamicImport = !1);
                      const t = p.Z.workers.loaderConfig,
                        r = y({
                        ...
                        o = { version: l.i8, buildDate: v.r, revision: v.$ };
            ...
            if (k)
              try {
                e = new Worker(k, { name: 'esri-worker-' + E++ });
              } catch (t) {
                _.warn(j, S), (e = new w());
              }
            else _.warn(j, S), (e = new w());
            return R(e);
          })();
          return new I(t, e);
        }
        ...
        async open(e, t = {}) {
          ...
          return new Promise((t, s) => {
            const i = {
              ...
              reject: s,
              abortHandle: (0, n.$F)(r, () => {
                this._outJobs.delete(o), this._post({ type: P, jobId: o });
              }),
            };
            this._outJobs.set(o, i),
              this._post({ type: Z, jobId: o, modulePath: e });
          });
        }
        _onMessage(e) {
          const t = (0, u.QM)(e);
        ...
        _onInvokeMessage(e) {
          const { methodName: t, jobId: r, data: o, abortable: s } = e,
          ...
          try {
            ...
            c = d.call(null, o, { signal: i ? i.signal : null });
          } catch (e) {
            return void this._post({ type: O, jobId: r, error: (0, u.AB)(e) });
          }
          (0, n.y8)(c)
            ? (a.set(r, { controller: i, promise: c }),
              c.then(
                (e) => {
                  a.has(r) &&
                    (a.delete(r), this._post({ type: O, jobId: r }, e));
                },
                (e) => {
                  a.has(r) &&
                    (a.delete(r),
        ...
        _onResponseMessage(e) {
          var t;
          const { jobId: r, error: s, data: n } = e,
            i = this._outJobs.get(r);
          i &&
            (this._outJobs.delete(r),
            null == (t = i.abortHandle) || t.remove(),
            s ? i.reject(o.Z.fromJSON(JSON.parse(s))) : i.resolve(n));
        }
        _post(e, t, r) {
          return (0, u.oi)(this.worker, e, t, r);
        }
      }
      let F = (0, s.Z)('esri-workers-debug')
        ? 1
        : (0, s.Z)('host-browser')
      ...
      async function T(e, t = {}) {
        ...
        if (
          ...
          const o = t.client || r;
          return B([a.default.connect(r)], { ...t, client: o });
        }
        if (
          (await (async function () {
            ...
            const e = [];
            for (let t = 0; t < F; t++) {
              const r = I.create(t).then((e) => ((L[t] = e), e));
              e.push(r);
            }
            return (H = Promise.all(e)), H;
          })(),
          (0, n.k_)(t.signal),
          'dedicated' === r)
        ) {
          const r = A++ % F;
          return B([await L[r].open(e, t)], t);
        }
    ...
    94443: (e, t, r) => {
      ...
      const d = [],
        u = new Map();
      function c(e) {
        for (const t of u.keys()) y(e.pattern, t) && u.delete(t);
      }
      function p(e) {
        return (
          d.includes(e) || (c(e), d.unshift(e)),
          {
            remove() {
              const t = d.indexOf(e);
              t > -1 && (d.splice(t, 1), c(e));
            },
          }
        );
      }
    ...
    940: (e, t, r) => {
        ...
        return (0, n.gx)(e, (e) =>
          (function (e, t, r) {
            ...
            if (
              (-1 === i
                ? (o = e.trim())
                : ((o = e.slice(0, i).trim()), (n = e.slice(i + 1).trim())),
              !o)
            )
              return '';
            const a = (0, s.hS)(o, t);
      ...
      function u(e, t) {
        switch (t.type) {
          ...
          default:
            return l.warn('missing format descriptor for key {key}'), p(e);
        }
      }
      function c(e, t) {
    ...
    56545: (e, t, r) => {
      ...
      (0, s._)(
        ...
        (0, s._)(
          [(0, a.Cb)({ type: Boolean, json: { default: !1, write: !0 } })],
          c.prototype,
          'returnMetadata',
          void 0,
        ),
        ...
        (c = o = (0, s._)([(0, d.j)('esri.rest.support.AttachmentQuery')], c)),
        (c.from = (0, l.se)(c));
      const p = c;
    },
    74889: (e, t, r) => {
      ...
      let b = (o = class extends l.wq {
        ...
        readFeatures(e, t) {
          ...
          for (let t = 0; t < e.length; t++) {
            ...
            (0, u.pC)(n.geometry) && !a && (n.geometry.spatialReference = r);
            const l = s.aggregateGeometries,
              d = n.aggregateGeometries;
            if (l && (0, u.pC)(d))
              for (const e in d) {
                const t = d[e],
                  o = l[e],
                  s = null == o ? void 0 : o.spatialReference;
                (0, u.pC)(t) && !s && (t.spatialReference = r);
              }
            o.push(n);
          }
          return o;
        ...
        writeGeometryType(e, t, r, o) {
          if (e) return void w.write(e, t, r, o);
          const { features: s } = this;
          if (s)
            for (const e of s)
              if (e && (0, u.pC)(e.geometry))
                return void w.write(e.geometry.type, t, r, o);
        }
        readQueryGeometry(e, t) {
          ...
          return (
            !r &&
              t.spatialReference &&
              (o.spatialReference = y.Z.fromJSON(t.spatialReference)),
            o
          );
        }
        ...
        quantize(e) {
          ...
          for (let e = 0, t = n.length; e < t; e++)
            i((0, u.Wg)(n[e].geometry)) || (n.splice(e, 1), e--, t--);
          ...
          for (let i = 0, a = e.length; i < a; i++) {
            ...
            if (i > 0) {
              const e = t(a[0]),
                i = r(a[1]);
              (e === o && i === s) ||
                (n.push([e - o, i - s]), (o = e), (s = i));
            } else (o = t(a[0])), (s = r(a[1])), n.push([o, s]);
          }
        ...
        _getQuantizationFunction(e, t, r) {
          return 'point' === e
            ...
            ? (e) => {
                const o = (0, m.oU)(e) ? e.rings : e.paths,
                  s = [];
      ...
      (0, s._)(
        ...
        (0, s._)(
          [(0, c.Cb)({ type: [i.Z], json: { write: !0 } })],
          b.prototype,
          'features',
          void 0,
        ),
        (0, s._)([(0, p.r)('features')], b.prototype, 'readFeatures', null),
        (0, s._)(
        ...
        (0, s._)(
          [(0, c.Cb)({ types: n.qM, json: { write: !0 } })],
          b.prototype,
          'queryGeometry',
          void 0,
        ),
        ...
        (b = o = (0, s._)([(0, h.j)('esri.rest.support.FeatureSet')], b)),
    ...
    75935: (e, t, r) => {
      ...
      (0, s._)(
        ...
        (0, s._)(
          [(0, u.c)('historicMoment')],
          h.prototype,
          '_writeHistoricMoment',
          null,
        ),
        (0, s._)(
          [(0, a.Cb)({ type: Number, json: { write: !0 } })],
        ...
        (h = o =
          (0, s._)([(0, d.j)('esri.rest.support.RelationshipQuery')], h)),
        (h.from = (0, l.se)(h));
      const f = h;
    },
    28141: (e, t, r) => {
      ...
      (0, s._)(
        ...
        (y = o = (0, s._)([(0, p.j)('esri.rest.support.TopFilter')], y));
      const m = y;
      var g,
        w = r(82971);
      const b = new a.X({
      ...
      (0, s._)(
        ...
        (0, s._)(
          [(0, u.Cb)({ types: n.qM, json: { read: f.im, write: !0 } })],
          _.prototype,
          'geometry',
          void 0,
        ),
        ...
        (0, s._)(
          [
            (0, u.Cb)({
              type: String,
              json: {
                read: { source: 'spatialRel', reader: b.read },
                write: { target: 'spatialRel', writer: b.write },
              },
            }),
          ],
          _.prototype,
        ...
        (_ = g = (0, s._)([(0, p.j)('esri.rest.support.TopFeaturesQuery')], _)),
        (_.from = (0, c.se)(_));
      const C = _;
    },
  },
