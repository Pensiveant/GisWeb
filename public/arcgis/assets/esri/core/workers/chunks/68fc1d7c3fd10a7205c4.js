...
(self.webpackChunkRemoteClient = self.webpackChunkRemoteClient || []).push([
  ...
  {
    66643: (e, t, i) => {
      i.d(t, { Ed: () => a, UI: () => n, q6: () => s, mt: () => l });
      var r = i(70586),
        o = i(95330);
      function a(e, t, i) {
        return (0, o.as)(e.map((e, r) => t.apply(i, [e, r])));
      }
      function n(e, t, i) {
        return (0, o.as)(e.map((e, r) => t.apply(i, [e, r]))).then((e) =>
          e.map((e) => e.value),
        );
      }
      function s(e) {
    ...
    15235: (e, t, i) => {
      ...
      (0, r._)([(0, d.Cb)()], k.prototype, 'portalItem', void 0),
        (0, r._)(
        ...
        (0, r._)([(0, f.p)('path')], k.prototype, '_castPath', null),
        (0, r._)(
        ...
        (k = (0, r._)([(0, m.j)('esri.portal.PortalItemResource')], k));
      const x = k;
      ...
      const O = C;
      var _;
      let S = (_ = class extends (0, n.eC)(l.Z) {
        constructor(e) {
          super(e),
            (this.access = null),
          ...
          return (
            ...
            'wfs' === e
              ? ((r = t.indexOf('Hosted Service') > -1),
                ...
                'wfs' === e
                  ? ((a = t.indexOf('Table') > -1),
                    (n = t.indexOf('Route Layer') > -1),
                    (s = t.indexOf('Markup') > -1),
        ...
        clone() {
          const e = {
            ...
            applicationProxies: (0, s.d9)(this.applicationProxies),
            avgRating: this.avgRating,
            categories: (0, s.d9)(this.categories),
            created: (0, s.d9)(this.created),
            culture: this.culture,
            description: this.description,
            extent: (0, s.d9)(this.extent),
            groupCategories: (0, s.d9)(this.groupCategories),
            id: this.id,
            itemControl: this.itemControl,
            licenseInfo: this.licenseInfo,
            modified: (0, s.d9)(this.modified),
            name: this.name,
            ...
            portal: this.portal,
            screenshots: (0, s.d9)(this.screenshots),
            size: this.size,
            snippet: this.snippet,
            tags: (0, s.d9)(this.tags),
            thumbnail: this.thumbnail,
            title: this.title,
            type: this.type,
            typeKeywords: (0, s.d9)(this.typeKeywords),
            url: this.url,
          };
          return (
      ...
      (0, r._)(
        ...
        (0, r._)([(0, d.Cb)({ type: y.Z })], S.prototype, 'extent', void 0),
        ...
        (0, r._)([(0, d.Cb)({ type: g.Z })], S.prototype, 'portal', void 0),
