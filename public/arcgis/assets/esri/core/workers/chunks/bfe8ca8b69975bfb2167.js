  ...
  [7793],
  {
    24133: (e, t, n) => {
      ...
      class a {
        ...
        destroy() {
          this.clear(), I.prune(), b.prune(), S.prune(), w.prune();
        }
        all(e) {
            ...
            for (I.clear(); n; ) {
              for (let s = 0, r = n.children.length; s < r; s++) {
                const r = n.children[s],
                  o = n.leaf ? i(r) : r;
                _(e, o) &&
                  (n.leaf ? t(r) : y(e, o) ? this._all(r, t) : I.push(r));
              }
              n = I.pop();
            }
        }
        ...
        remove(e) {
          ...
          for (S.clear(), w.clear(); n || S.length > 0; ) {
            var d;
            if (
              (n ||
                ((n = (0, s.j0)(S.pop())),
              ...
              return (
                n.children.splice(t, 1), S.push(n), this._condense(S), this
              );
            a || n.leaf || !y(n, l)
              ? r
                ? (o++, (n = r.children[o]), (a = !1))
                : (n = null)
              : (S.push(n), w.push(o), (o = 0), (r = n), (n = n.children[0]));
          }
          return this;
        }
        toJSON() {
        ...
        _all(e, t) {
          ...
          for (b.clear(); n; ) {
            ...
            else b.pushArray(n.children);
            n = null != (i = b.pop()) ? i : null;
          }
        }
        _build(e, t, n, i) {
          const s = n - t + 1;
          ...
          if (s <= r) {
            const i = new B(e.slice(t, n + 1));
            return l(i, this._toBBox), i;
          }
          i ||
          ...
          x(e, t, n, d, this.compareMinX);
          for (let s = t; s <= n; s += d) {
            const t = Math.min(s + d - 1, n);
            x(e, s, t, a, this.compareMinY);
            for (let n = s; n <= t; n += a) {
              const s = Math.min(n + a - 1, t);
              o.children.push(this._build(e, n, s, i - 1));
            }
          }
        ...
        _split(e, t) {
          ...
          const o = n.children.splice(r, n.children.length - r),
            a = n.leaf ? new B(o) : new v(o);
          (a.height = n.height),
            l(n, this._toBBox),
            l(a, this._toBBox),
        ...
        _chooseSplitAxis(e, t, n) {
          const i = e.leaf ? this.compareMinX : c,
            s = e.leaf ? this.compareMinY : h;
        ...
        _allDistMargin(e, t, n, i) {
          ...
          for (let i = t; i < n - t; i++) {
            ...
            u(r, e.leaf ? s(t) : t), (a += p(r));
          }
          for (let i = n - t - 1; i >= t; i--) {
            const t = e.children[i];
            u(o, e.leaf ? s(t) : t), (a += p(o));
          }
          return a;
        }
        _adjustParentBBoxes(e, t, n) {
          for (let i = n; i >= 0; i--) u(t.data[i], e);
        }
        _condense(e) {
      ...
      function d(e, t, n, i, s) {
        s || (s = new B([])),
          ...
          (s.maxY = -1 / 0);
        for (let r, o = t; o < n; o++)
          (r = e.children[o]), u(s, e.leaf ? i(r) : r);
        return s;
      }
      function u(e, t) {
      ...
      function x(e, t, n, i, r) {
        ...
        for (; a.length; ) {
          const t = (0, s.j0)(a.pop()),
            n = (0, s.j0)(a.pop());
          if (t - n <= i) continue;
          const l = n + Math.ceil((t - n) / i / 2) * i;
          (0, o.q)(e, l, n, t, r), a.push(n, l, l, t);
        }
      }
      const I = new r.Z(),
        b = new r.Z(),
    ...
    14808: (e, t, n) => {
      ...
      function o(e) {
        ...
        if (!t) {
          const n = e.split('-');
          n.length > 1 && n[0] in r && ((e = n[0]), (t = !0)), t || (e = 'en');
        }
        const [n, i, o = '#,##0.###'] = r[e];
        return { decimal: n, group: i, pattern: o };
      }
      function a(e, t) {
        const n = o((t = { ...t }).locale);
        t.customs = n;
        const i = t.pattern || n.pattern;
        return isNaN(e) || Math.abs(e) === 1 / 0
          ? null
          : (function (e, t, n) {
              const i = (n = n || {}).customs.group,
                s = n.customs.decimal,
                r = t.split(';'),
                o = r[0];
              if (-1 !== (t = r[e < 0 ? 1 : 0] || '-' + o).indexOf('%'))
                e *= 100;
              ...
              return (
                ...
                t.replace(
                  ...
                  (function (e, t, n) {
                    ...
                    let r = n.places;
                    s
                      ? (r = n.places.substring(s + 1))
                      : r >= 0 || (r = (i[1] || []).length),
                      n.round < 0 || (e = Number(e.toFixed(Number(r))));
                    ...
                    if (i[1] || n.places) {
                      ...
                      const e =
                        void 0 !== n.places
                          ? n.places
                          : i[1] && i[1].lastIndexOf('0') + 1;
                      e > a.length && (o[1] = a.padEnd(Number(e), '0')),
                        r < a.length && (o[1] = a.substr(0, Number(r)));
                    } else o[1] && o.pop();
                    const l = i[0].replace(',', '');
                    let d = l.indexOf('0');
                    -1 !== d &&
                      ((d = l.length - d),
                      d > o[0].length && (o[0] = o[0].padStart(d, '0')),
                      -1 === l.indexOf('#') &&
                        (o[0] = o[0].substr(o[0].length - d)));
                    let u,
                      c,
                      h = i[0].lastIndexOf(',');
                    if (-1 !== h) {
                      u = i[0].length - h - 1;
                      const e = i[0].substr(0, h);
                      (h = e.lastIndexOf(',')),
                        -1 !== h && (c = e.length - h - 1);
                    }
                    const f = [];
                    for (let e = o[0]; e; ) {
                      const t = e.length - u;
                      f.push(t > 0 ? e.substr(t) : e),
                        (e = t > 0 ? e.slice(0, t) : ''),
                        c && ((u = c), (c = void 0));
                    }
                    return (
                      (o[0] = f.reverse().join(n.group || ',')),
                      o.join(n.decimal || '.')
                    );
                  })(e, d[0], {
                    decimal: s,
              ...
              function (t) {
                ...
                1 === i.length && 1 !== a && (i[1] = '###'),
                  1 === i.length || 0 === o
                    ? (n.fractional = !1)
                    : (void 0 === o &&
                        (o = e.pattern ? i[1].lastIndexOf('0') + 1 : 1 / 0),
                      o && null == e.fractional && (n.fractional = !0),
                      !e.places && o < i[1].length && (o += ',' + i[1].length),
                      (n.places = o));
                const l = i[0].split(',');
                return (
                  l.length > 1 &&
                    ((n.groupSize = l.pop().length),
                    l.length > 1 && (n.groupSize2 = l.pop().length)),
                  '(' +
                    (function (e) {
                      ...
                      return (
                        n && (i = '(?:(?:' + i + ')|(?:' + n + '))'),
                        i +
                          h(e.exponent, function (t) {
                            return t
                              ? '([eE]' + c({ signed: e.eSigned }) + ')'
                              : '';
                          })
                      );
                    })(n) +
      ...
      const h = function (e, t, n) {
          ...
          const i = [];
          for (let n = 0; n < e.length; n++) i.push(t(e[n]));
          return f(i.join('|'), n);
        },
        f = function (e, t) {
          return '(' + (t ? '?:' : '') + e + ')';
    ...
    70171: (e, t, n) => {
      var i, s, r;
      let o;
      n.d(t, { Ze: () => f, Kd: () => d, qe: () => c });
      const a =
        null != (i = null == (s = globalThis.esriConfig) ? void 0 : s.locale)
          ? i
          : null == (r = globalThis.dojoConfig)
          ? void 0
          : r.locale;
      function l() {
        var e, t;
    ...
    57191: (e, t, n) => {
      ...
      const p = {
        ...
        getCentroid: (e, t) => (
          (0, o.Wi)(e.centroid) &&
            (e.centroid = (0, c.Y)(new f.Z(), e.geometry, t.hasZ, t.hasM)),
          e.centroid
        ),
      };
      class m {
        ...
        forEachBounds(e, t, n) {
          for (const i of e) {
            const e = this._boundsStore.get(i.objectId);
            e && t((0, a.JR)(n, e));
          }
        }
        getFeature(e) {
        ...
        _add(e) {
          ...
          if (null == t)
            return void r.Z.getLogger(
              ...
              new i.Z('featurestore:invalid-feature', 'feature id is missing', {
                feature: e,
              }),
            );
    ...
    27793: (e, t, n) => {
      ...
      function* b(e, t, n) {
        ...
        for (; i <= e.length; ) {
          const s = e.indexOf(t, i),
            r = e.substring(i, s > -1 ? s : void 0);
          (i += r.length + t.length), (n && !r.trim()) || (yield r);
        }
      }
      function S(e) {
        const t = e.includes('\r\n') ? '\r\n' : '\n';
      ...
      function F(e) {
        ...
        let n = 0,
          i = '';
        for (const e of I) {
          const s = t.split(e).length;
          s > n && ((n = s), (i = e));
        }
        return '' === i ? null : i;
      }
      function* B(e, t, n, i = () => Object.create(null)) {
        let s = '',
          r = '',
          o = 0,
          a = i(),
          ...
          for (const d of e)
            if (((s += r + d), (r = ''), (o += v(d)), o % 2 == 0)) {
              if (o > 0) {
                ...
                (a[t[l]] = e[1].replace(x, '"')), l++;
              } else (a[t[l]] = s), l++;
              (s = ''), (o = 0);
            } else r = n;
          0 === o ? (yield a, (a = i()), (l = 0)) : (r = '\n');
        }
      }
      function v(e) {
        let t = 0,
      ...
      var E = n(25278),
        ...
        M = n(35671),
        T = n(82971);
      const C = (0, E.bU)('esriGeometryPoint'),
        Y = ['csv'],
        O = [0, 0];
      class X {
        constructor(e, t) {
      ...
      class j {
        ...
        async load(e, t = {}) {
          ...
          const [i] = await Promise.all([
              this._fetch(t.signal),
              this._checkProjection(
                null == e || null == (n = e.parsingOptions)
                  ? void 0
                  : n.spatialReference,
              ),
            ]),
            r = (function (e, t) {
              const n = t.parsingOptions || {},
                i = {
              ...
              let o = r.next().value;
              if (!o)
                throw new s.Z('csv-layer:empty-csv', 'CSV is empty', {
                  csv: e,
                });
              ...
              const a = o.split(i.delimiter).filter((e) => !!e),
                d = (i.layerDefinition = {
                  name: (0, l.vt)(t.url, Y) || 'csv',
                  drawingInfo: C,
                  ...
                  extent: {
                    ...
                    spatialReference: n.spatialReference || { wkid: 102100 },
                  },
                });
              if (!n.latitudeField || !n.longitudeField) {
                const e = q(a);
                if (
                  (!n.longitudeField && !e.longitudeFieldName) ||
                  (!n.latitudeField && !e.latitudeFieldName)
                )
                  throw new s.Z(
              ...
              const u = D(r, i.delimiter, a, i.locationInfo);
              if (n.fields && n.fields.length) {
                const e = new Map();
                for (const t of n.fields) e.set(t.name.toLowerCase(), t);
                for (const t of u) {
                  const n = e.get(t.name.toLowerCase());
                  if (n) {
                    const e = t.name;
                    Object.assign(t, n), (t.name = e);
                  }
                }
              }
              if (
              ...
              if (d.timeInfo) {
                const e = new N.Z(d.fields),
                  t = d.timeInfo;
                if (t.startTimeField) {
                  const n = e.get(t.startTimeField);
                  n
                    ? ((t.startTimeField = n.name),
                      (n.type = 'esriFieldTypeDate'))
                    : (t.startTimeField = null);
                }
                if (t.endTimeField) {
                  const n = e.get(t.endTimeField);
                  n
                    ? ((t.endTimeField = n.name),
                      (n.type = 'esriFieldTypeDate'))
                    : (t.endTimeField = null);
                }
                if (t.trackIdField) {
                  const n = e.get(t.trackIdField);
                  t.trackIdField = n ? n.name : null;
                }
                t.startTimeField || t.endTimeField || (d.timeInfo = null);
              }
              return i;
            })(i, e);
          (this.locationInfo = r.locationInfo),
            (this.delimiter = r.delimiter),
            (this._queryEngine = this._createQueryEngine(r));
          const o = await this._createFeatures(i);
          if (
            (this._queryEngine.featureStore.addMany(o),
            (r.layerDefinition.extent = this._queryEngine.fullExtent),
            r.layerDefinition.timeInfo)
          ) {
          ...
          return (
            ...
            this._snapshotTask.promise.then(
              ...
              (e) => {
                this._queryEngine.featureStore.clear(),
                  (0, a.D_)(e) ||
                    r.Z.getLogger('esri.layers.CSVLayer').error(
                      new s.Z(
                        'csv-layer:refresh',
        ...
        async _fetch(e) {
          const { url: t, customParameters: n } = this.loadOptions;
          if (!t) throw new s.Z('csv-layer:invalid-source', 'url not defined');
          const r = (0, l.mN)(t);
          return (
            await (0, i.default)(r.path, {
              query: { ...r.query, ...n },
              responseType: 'text',
              signal: e,
            })
        ...
        async _createFeatures(e) {
          const { latitudeFieldName: t, longitudeFieldName: n } =
              this.locationInfo,
            {
              objectIdField: i,
              fieldsIndex: s,
          ...
          let o = [];
          const a = [],
            l = s.fields.filter((e) => e.name !== i).map((e) => e.name);
          let m = 0;
          const g = S(e);
          g.next();
          const y = {};
          ...
          const _ = B(g, l, this.delimiter, (0, E.Dm)(y, i));
          for (const e of _) {
            const r = this._parseCoordinateValue(e[t]),
              l = this._parseCoordinateValue(e[n]);
            if (null != l && null != r && !isNaN(r) && !isNaN(l)) {
              (e[t] = r), (e[n] = l);
              for (const i in e)
                if (i !== t && i !== n)
                  if (s.isDateField(i)) {
                    const t = new Date(e[i]);
                    e[i] = P(t, e[i]) ? t.getTime() : null;
                  } else if (s.isNumericField(i)) {
                    const t = z(e[i]);
                    isNaN(t) ? (e[i] = null) : (e[i] = t);
                  }
              (e[i] = m), m++, o.push(new X(l, r)), a.push(e);
            }
          }
          if (!(0, c.fS)({ wkid: 4326 }, r))
            if ((0, c.sS)(r))
              for (const e of o) [e.x, e.y] = (0, h.hG)(e.x, e.y, O);
            else o = (0, d.oj)(u.N, o, T.Z.WGS84, r, null);
          const x = [];
          for (let e = 0; e < o.length; e++) {
            const { x: t, y: n } = o[e],
              s = a[e];
            (s[i] = e + 1),
              x.push(new f.u_(new p.Z([], [t, n]), s, null, s[i]));
          }
          return x;
        }
      ...
      function q(e) {
        ...
        return {
          ...
          latitudeFieldName: e[t.indexOf(Z.find((e) => t.includes(e)))],
        };
      }
      function D(e, t, n, i) {
        const s = [],
        ...
        for (const e of n)
          if (e === i.longitudeFieldName || e === i.latitudeFieldName)
            s.push({ name: e, type: 'esriFieldTypeDouble', alias: e });
          else {
            const t = L(o.map((t) => t[e])),
              n = { name: e, type: null, alias: e };
            switch (t) {
              case 'integer':
                n.type = 'esriFieldTypeInteger';
                break;
              case 'double':
                n.type = 'esriFieldTypeDouble';
                break;
              case 'date':
                (n.type = 'esriFieldTypeDate'), (n.length = 36);
                break;
              default:
                (n.type = 'esriFieldTypeString'), (n.length = 255);
            }
            s.push(n);
          }
        return s;
              ...
              if (t.test(e)) n = !0;
                ...
                if (-1 === e.indexOf('E')) n = !0;
                  ...
                  if (-1 === e.indexOf(',')) n = !0;
                    ...
                    if (((e = e.replace(',', '.')), (t = Number(e)), !isNaN(t)))
                      return 'double';
                    n = !0;
                  }
                }
      ...
      const A =
        ...
        R = Number.isNaN(new Date('technology 10').getTime());
      function P(e, t) {
        if (
          !e ||
        ...
        if (!R && /\d+\W*$/.test(t)) {
          ...
          if (e) {
            let t = !1,
              i = 0;
            for (; !t && i <= e.length; ) (t = !A.test(e[i])), i++;
            n = !t;
          }
        }
        return n;
      ...
      const z = (function () {
        const e = (0, o.lt)(),
          ...
          n = new RegExp('[' + e.group + '\\s\\xa0]', 'g'),
          i = e.factor;
        return function (s) {
          const r = t.exec(s);
          if (((e.factor = i), !r)) return NaN;
          let o = r[1];
          if (!r[1]) {
            if (!r[2]) return NaN;
            (o = r[2]), (e.factor *= -1);
          }
          return (o = o.replace(n, '').replace(e.decimal, '.')), +o * e.factor;
        };
      })();
    },
    25278: (e, t, n) => {
      n.d(t, { MS: () => h, Dm: () => u, Hq: () => c, bU: () => a });
      var i = n(80442),
        s = n(22974),
        r = n(61159),
        o = n(58333);
      ...
      function u(e, t) {
        ...
        try {
          let n = `this.${t} = null;`;
          for (const t in e)
            n += `this${l.test(t) ? `.${t}` : `["${t}"]`} = ${JSON.stringify(
              e[t],
            )};`;
    ...
    58333: (e, t, n) => {
      ...
      const i = [252, 146, 31, 255],
        ...
        r = { type: 'esriSLS', style: 'esriSLSSolid', width: 0.75, color: i },
        o = {
          type: 'esriSFS',
          style: 'esriSFSSolid',
