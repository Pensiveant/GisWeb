  ...
  [9296],
  {
    ...
    39296: (t, e, r) => {
      ...
      let d = class extends (0, p.I)((0, o.R)(u.Z)) {
        constructor(t) {
          super(t), (this.resourceInfo = null), (this.type = 'unsupported');
        }
        initialize() {
          this.addResolvingPromise(
            new Promise((t, e) => {
              (0, n.Os)(() => {
                ...
                let r = 'Unsupported layer type';
                t && (r += ' ' + t),
                  e(
                    new s.Z('layer:unsupported-layer-type', r, {
                      layerType: t,
                    }),
                  );
              });
        ...
        read(t, e) {
          const r = { resourceInfo: t };
          null != t.id && (r.id = t.id),
            null != t.title && (r.title = t.title),
            super.read(r, e);
        }
        write(t) {
          return Object.assign(t || {}, this.resourceInfo, { id: this.id });
        }
      };
      (0, i._)(
        [(0, a.Cb)({ readOnly: !0 })],
        ...
        (d = (0, i._)([(0, l.j)('esri.layers.UnsupportedLayer')], d));
      const h = d;
    },
    16859: (t, e, r) => {
      r.d(e, { I: () => _ });
