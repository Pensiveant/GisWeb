...
(self.webpackChunkRemoteClient = self.webpackChunkRemoteClient || []).push([
  [4579, 8062],
  {
    87344: (e, a, t) => {
      ...
      const r = {
        BingMapsLayer: async () =>
          (await Promise.all([t.e(6968), t.e(2397)]).then(t.bind(t, 2723)))
            .default,
        ...
        ElevationLayer: async () =>
          (await Promise.all([t.e(9151), t.e(9932)]).then(t.bind(t, 49932)))
            .default,
        FeatureLayer: async () =>
          (
            await Promise.all([
        ...
        GroupLayer: async () =>
          (await Promise.all([t.e(6968), t.e(214)]).then(t.bind(t, 63144)))
            .default,
        GeoRSSLayer: async () =>
          (
            await Promise.all([t.e(6968), t.e(7319), t.e(4959)]).then(
              t.bind(t, 3723),
            )
          ).default,
        GeoJSONLayer: async () =>
        ...
        IntegratedMeshLayer: async () =>
          (
            await Promise.all([t.e(4547), t.e(86), t.e(8297)]).then(
              t.bind(t, 4717),
            )
          ).default,
        KMLLayer: async () =>
        ...
        OpenStreetMapLayer: async () =>
          (
            await Promise.all([t.e(6968), t.e(678), t.e(6237)]).then(
              t.bind(t, 66237),
            )
          ).default,
        PointCloudLayer: async () =>
          (
            await Promise.all([t.e(1773), t.e(86), t.e(1197)]).then(
              t.bind(t, 10608),
            )
          ).default,
        RouteLayer: async () =>
        ...
        UnknownLayer: async () =>
          (await t.e(4166).then(t.bind(t, 44166))).default,
        UnsupportedLayer: async () =>
          (await t.e(9296).then(t.bind(t, 39296))).default,
        ...
        VoxelLayer: async () =>
          (await Promise.all([t.e(86), t.e(5410)]).then(t.bind(t, 58092)))
            .default,
        WebTileLayer: async () =>
          (await Promise.all([t.e(6968), t.e(678)]).then(t.bind(t, 16199)))
            .default,
        WFSLayer: async () =>
          (
            await Promise.all([
        ...
        WMTSLayer: async () =>
          (
            await Promise.all([t.e(6968), t.e(678), t.e(5853)]).then(
              t.bind(t, 55853),
            )
          ).default,
      };
    ...
    18062: (e, a, t) => {
                ...
                return (
                  ...
                  (function (e, a) {
                    ...
                    return t()
                      ...
                      .then(async (a) =>
                        'Feature Service' === l
                          ? ((a = await m(a, e.portalItem.url)), c(e, i, a))
                          : f(a) > 0
                          ? c(e, i, a)
                          : (function (e, a) {
                              return e.portalItem.url
                                ? (0, o.b)(e.portalItem.url).then((t) => {
                                    var r, n;
                                    function l(e) {
          ...
          .then(async (e) => {
            if (
              ...
              return (
                ...
                r &&
                  'service-name' !== t.sublayerTitleMode &&
                  (t.sublayerTitleMode = 'item-title-and-service-name'),
                a
              );
            }
            return e;
      ...
      async function m(e, a) {
        var t, r;
        if (
          null == (null == (t = e) ? void 0 : t.layers) ||
          null == (null == (r = e) ? void 0 : r.tables)
        ) {
          const t = await (0, o.b)(a);
          ((e = e || {}).layers = e.layers || (null == t ? void 0 : t.layers)),
            (e.tables = e.tables || (null == t ? void 0 : t.tables));
        }
        return e;
      }
      function p(e) {
      ...
      function f(e) {
        var a, t, r, n;
        return (
          (null != (a = null == e || null == (t = e.layers) ? void 0 : t.length)
            ? a
            : 0) +
          (null != (r = null == e || null == (n = e.tables) ? void 0 : n.length)
            ? r
            : 0)
        );
      }
    ...
    44579: (e, a, t) => {
      t.r(a), t.d(a, { fromItem: () => u, selectLayerClassPath: () => c });
      var r = t(20102),
        n = t(87344),
        l = t(15235),
        i = t(18062);
      ...
      function u(e) {
        return (
          ...
          (function (e) {
            return e.load().then(c).then(y);
          })(e.portalItem).then((a) => {
            const t = { portalItem: e.portalItem, ...a.properties },
              r = a.constructor;
      ...
      function c(e) {
        switch (e.type) {
          case 'Map Service':
            return (function (e) {
              return (0, o.b)(e.url).then((e) => e.tileInfo);
            })(e).then((e) =>
            ...
            return (function (e) {
              return d(e).then((a) => {
                if ('object' == typeof a) {
                  ...
                  if (
                    (null != a.id
                      ? ((t.layerId = a.id), (r = `${e.url}/layers/${a.id}`))
                      : (r = e.url),
                    ...
                    for (const t of Object.keys(a))
                      if (-1 !== e.typeKeywords.indexOf(t))
                        return { className: a[t] };
                  }
                  return (0, o.b)(r).then((e) => {
                    let a = 'SceneLayer';
                    const r = {
                      Point: 'SceneLayer',
                      '3DObject': 'SceneLayer',
          ...
          case 'Image Service':
            return (async function (e) {
              ...
              return 'ArcGISTiledImageServiceLayer' === i
                ...
                : 'map' ===
                  (null == (r = (await (0, o.b)(e.url)).cacheType)
                    ? void 0
                    : r.toLowerCase())
                ? { className: 'ImageryTileLayer' }
                : { className: 'ImageryLayer' };
          ...
          : e
              ...
              .then(async (a) =>
                'Feature Service' === e.type
                  ? m((a = await (0, i.preprocessFSItemData)(a, e.url)))
    ...
    40555: (e, a, t) => {
      ...
      async function i(e, a, t) {
        ...
        if (i && 'unique-value' === i.type && i.styleOrigin) {
          const s = await (0, r.q6)(i.populateFromStyle());
          if (((0, n.k_)(t), !1 === s.ok)) {
            const t = s.error;
            a &&
              a.messages &&
              a.messages.push(
                new l.Z(
                  ...
                  `Failed to create unique value renderer from style reference: ${t.message}`,
                  { error: t, context: a },
                ),
              ),
    ...
    96187: (e, a, t) => {
      ...
      var r = t(3172);
      async function n(e) {
        const { data: a } = await (0, r.default)(e, {
          responseType: 'json',
          query: { f: 'json' },
        });
        return a;
